        ...
        <section className="grid flex-1 items-center gap-8 py-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(360px,0.65fr)] lg:py-14">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-pretty text-base leading-7 text-muted-foreground sm:text-lg">
              Registra ingresos, egresos, deudas y metas de ahorro en un solo
              sistema. La experiencia esta pensada para ver tu mes con claridad
              y tomar mejores decisiones sin friccion.
            </p>
          ...
          <Card className="bg-card/90">
            ...
            <CardContent className="space-y-5">
              <Progress value={68} aria-label="Progreso financiero del mes" />
              <div className="grid grid-cols-3 gap-3 text-sm">
                <div>
                  <p className="finance-number font-semibold">$2.4M</p>
                  <p className="text-muted-foreground">Necesidades</p>
                </div>
                <div>
                  <p className="finance-number font-semibold">$1.1M</p>
                  <p className="text-muted-foreground">Deseos</p>
                </div>
                <div>
                  <p className="finance-number font-semibold">$820K</p>
